...
def main(argv=None, save_main_session=True):
  ...
  parser.add_argument('--input',
                      dest='input',
                      default='data\inputs\word_count.txt',
                      help='Input file to process.')
  
  parser.add_argument('--output',
                      dest='output', # CHANGE 1/6: (OPTIONAL) The GCS path is required for outputting the results.
                      default='data\outputs\count.txt',
...
# To run the beam python file, check the runner.txt
